/* @ds-bundle: {"format":4,"namespace":"SpudnikDesignSystem_8bfd55","components":[{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"StatusDot","sourcePath":"components/feedback/StatusDot.jsx"},{"name":"TerminalInput","sourcePath":"components/forms/TerminalInput.jsx"},{"name":"Toggle","sourcePath":"components/forms/Toggle.jsx"},{"name":"NavItem","sourcePath":"components/navigation/NavItem.jsx"},{"name":"DashboardApp","sourcePath":"ui_kits/dashboard/DashboardApp.jsx"},{"name":"LandingApp","sourcePath":"ui_kits/landing/LandingApp.jsx"}],"sourceHashes":{"components/core/Badge.jsx":"f0bed015c827","components/core/Button.jsx":"6ae1d224dadd","components/core/Card.jsx":"871ef0644407","components/feedback/StatusDot.jsx":"69caaaacf02c","components/forms/TerminalInput.jsx":"7bbd134e45a1","components/forms/Toggle.jsx":"6dbc76145482","components/navigation/NavItem.jsx":"64afc122f8d9","ui_kits/dashboard/DashboardApp.jsx":"b11fc5c1a529","ui_kits/landing/LandingApp.jsx":"f036b51b1a43","ui_kits/landing/image-slot.js":"0394ad34f685"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.SpudnikDesignSystem_8bfd55 = window.SpudnikDesignSystem_8bfd55 || {});
...
function Button({
  ...
  const base = {
    ...
    fontFamily: 'var(--font-mono)',
    font: s.font,
    letterSpacing: variant === 'ghost' ? 0 : undefined,
    padding: s.padding,
...
function Card({
  ...
  const accentBorder = accent === 'amber' ? 'var(--amber)' : accent === 'sage' ? 'var(--sage)' : 'var(--border)';
...
function TerminalInput({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      borderBottom: focused ? '2px solid var(--amber)' : '1px solid var(--border)',
      padding: '12px 16px',
...
Object.assign(__ds_scope, { TerminalInput });
__ds_ns.TerminalInput = TerminalInput;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/forms/TerminalInput.jsx", error: String((e && e.message) || e) }); }
...
function Toggle({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      borderRadius: 'var(--radius-sm)',
      background: checked ? 'rgba(143,181,168,.1)' : 'transparent',
      display: 'flex',
      alignItems: 'center',
      padding: 2,
...
function Sidebar({
  ...
  }, items.map(i => /*#__PURE__*/React.createElement(NavItem, _extends({
    key: i.label
  }, i, {
  ...
  }, "> REBOOT SYSTEM")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 4,
  ...
  }, footer.map(i => /*#__PURE__*/React.createElement(NavItem, _extends({
    key: i.label
  }, i)))));
}
function Orb() {
...
function RootBeerGauge({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    style: {
      height: 4,
      background: 'var(--tertiary-fixed, #f2bc8f)',
      opacity: 0.8
    }
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
...
function DashboardApp() {
  ...
  function renderMemory() {
    ...
    }, hasEntries ? memoryEntries.map((entry, i) => /*#__PURE__*/React.createElement(Card, {
      key: i
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
    ...
    }, entry.content), /*#__PURE__*/React.createElement("span", {
      style: {
        font: 'var(--text-code)',
        fontSize: 11,
        color: 'var(--text-secondary)',
    ...
    }, entry.timestamp)))) : /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("p", {
      style: {
        font: 'var(--text-body-sm)',
        margin: 0,
        color: 'var(--text-secondary)',
    ...
    }, "No memories yet — give him something to work with.")))), /*#__PURE__*/React.createElement("div", {
      style: {
        borderLeft: '2px solid var(--amber)',
        paddingLeft: 16
      }
    ...
    }, `"${hasEntries ? memoryEntries[0].content : 'No memories yet — give him something to work with.'}"`))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: 24
    ...
    }, "TOTAL ENTRIES"), /*#__PURE__*/React.createElement("span", {
      style: {
        font: 'var(--text-headline-md)',
        color: 'var(--amber)'
      }
    ...
    }, "LAST WRITE"), /*#__PURE__*/React.createElement("span", {
      style: {
        font: 'var(--text-code)',
        color: 'var(--text-primary)'
      }
  ...
  function renderProtocols() {
    ...
    }, "security"), /*#__PURE__*/React.createElement("h3", {
      style: {
        margin: 0,
        font: 'var(--text-headline-sm)',
        color: 'var(--text-primary)'
      }
    }, "Active Protocols")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        justifyContent: 'space-between',
        alignItems: 'baseline'
  ...
  }, headerTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--text-code)',
      color: 'var(--sage)',
      margin: '8px 0 0'
    }
  }, headerSubtitle)), /*#__PURE__*/React.createElement(StatusDot, {
    status: "success",
    label: "LINK ACTIVE",
    glow: true
...
function Nav() {
  ...
  }, "Spudnik"), /*#__PURE__*/React.createElement("a", {
    style: {
      color: 'var(--amber)',
...
function Hero() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      height: 380,
      borderRadius: '50%',
      background: 'radial-gradient(circle at 35% 30%, rgba(255,182,142,.55), rgba(232,135,76,.25) 45%, transparent 70%)',
      filter: 'blur(2px)'
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "SPUDNIK"), /*#__PURE__*/React.createElement("p", {
    style: {
      font: 'var(--text-title-sm)',
      color: 'var(--text-secondary)',
      borderLeft: '2px solid var(--amber)',
  ...
  }, "> SYSTEM_PROMPT: A personal AI assistant with an attitude problem.", /*#__PURE__*/React.createElement("br", null), "> STATUS: ONLINE & ANNOYED"), /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
    icon: "terminal",
...
function AboutBento() {
  ...
  }, "Tater is not your polite corporate assistant. Imagine a mentally unstable potato computer simulating a sarcastic 24-year-old tech genius who hasn't slept in three days."), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'var(--text-secondary)',
      margin: 0
    }
  }, "It doesn't \"helpfully summarize\" your emails; it judges them. It runs locally, consumes too much RAM, and complains when you ask it basic math questions."), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--bg-void)',
      border: '1px solid var(--border)',
      padding: 12,
  ...
  }, "user@host:~$"), " cat /var/log/tater_mood.log", /*#__PURE__*/React.createElement("br", null), "> WARNING: Caffeine levels low. Snark module engaged.")), /*#__PURE__*/React.createElement(Card, {
  ...
  }, "Local vs Cloud"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--text-secondary)'
    }
  }, "Because sending my unhinged diary entries to a corporate server feels bad. Everything runs on local metal."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, "Persona-Driven Design"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--text-secondary)'
    }
...
function Footer() {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\xA9 2026 Spudnik_Lab. All systems operational."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 24
    }
  ...
  }), "Status: Nominal"), /*#__PURE__*/React.createElement("span", null, "Stack: Flask/Ollama/Claude"), /*#__PURE__*/React.createElement("a", {
    href: "#"
  }, "GitHub"))));
}
function LandingApp() {
...
__ds_ns.DashboardApp = __ds_scope.DashboardApp;

__ds_ns.LandingApp = __ds_scope.LandingApp;
